...
### Code obfuscation on reactjs app
##### Run it with the 'npm start' command.
##### The app.js file was obfuscated with the javascript obfuscator and this obfuscated version was written to the AppObfuscated.js file. To run with unobfuscated code, replace AppObfuscated with App in the index.js file.You will see that the output is exactly the same, no matter how different it looks as an input.
    //Obfuscated
    ReactDOM.render(
